type DateFormat = "short" | "medium" | "long" | "super-long";

const locales = { locales: "fr-FR" };
...
export const formatDate = (
	...
	switch (format) {
		case "super-long":
			...
			return useDateFormat(date, "dddd, DD MMMM YYYY", locales).value;
		case "long":
			// Sat,14 jun 2025
			return useDateFormat(date, "ddd DD MMM YYYY", locales).value;
		case "medium":
			// 11 June 2025
			return useDateFormat(date, "DD MMMM YYYY", locales).value;
		default:
			// 11 Jun 2025
			return useDateFormat(date, "DD MMM YYYY", locales).value;
	}
};
...
// ex: useDateFormat(item.competition.date,"DD mm, YYYY HH:mm")
